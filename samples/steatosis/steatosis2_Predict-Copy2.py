...
def load_image(dataset, config, image_name):
    ...
    image = cv2.imread(dataset+"/"+image_name,1)
...
def Predict(DATASET_DIR,image_name,weights_path):
    ...
    image, image_meta = modellib.load_image(dataset,DATASET_DIR, config,image_name)
    ...
    filer(min_score, max_score, DATASET_DIR,results,image_name)
...
if __name__ == '__main__':
    ...
    Predict(DATASET_DIR,image_name,weights_path)
