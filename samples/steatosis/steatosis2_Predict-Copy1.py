...
def load_image(dataset, config, image_id):
...
def Predict(DATASET_DIR,weights_path):
    ...
    dataset.load_steatosis(DATASET_DIR, "")
    dataset.prepare()
    ...
    for image_id in range(0,len(dataset.image_ids)):
        ...
        filer(min_score, max_score, DATASET_DIR,results,image_id)
...
if __name__ == '__main__':
    ...
    # Dataset directory
    #DATASET_DIR = os.path.join(ROOT_DIR, "Dataset_MaskRCNN_1024_Test")
    ...
    Predict(DATASET_DIR,weights_path)
